...
def listPrint(L):
  ...
  current = L.head
  while current != None:
    print("FILE:",current.fileName,end="")
    print(" - REPS:", current.wordReps)
    current = current.nextNode
  print("")
...
list.head = filesNode()
current = list.head
current.fileName = "1.txt"
current.wordReps = 23
current.nextNode = filesNode()
current = current.nextNode
current.fileName = "2.txt"
current.wordReps = 15
current.nextNode = filesNode()
current = current.nextNode
current.fileName = "3.txt"
current.wordReps = 84
current.nextNode = filesNode()
current = current.nextNode
current.fileName = "4.txt"
current.wordReps = 5
